...
class Laporan_pemeriksaan_m extends MY_Model {
	...
	function getListLaporanPemeriksaan($jenis){
		...
		$this->db->select("a.id_periksa,a.kode_dokter,a.kode_pasien,convert(varchar(10),a.tgl_periksa,105) as tgl_periksa,a.diagnosa,d.penyakit, b.nama_dokter, c.nama,c.bagian,c.nip,c.gender");
    ...
    public function getLaporan($TGL_MULAI,$TGL_SELESAI){
		...
		$data = $this->db->query("SELECT a.id_periksa,a.kode_dokter,a.kode_pasien,convert(varchar(10),a.tgl_periksa,105) as tgl_periksa,a.diagnosa, b.nama_dokter, c.nama,c.bagian,c.nip,c.gender,d.penyakit FROM tbl_periksa a
