...
<table id="datagrid-m_periksa" title="" class="easyui-datagrid scrollbarx" 
		...
		data-options="
		url:'<?php echo base_url().'index.php/laporan_nonpegawai/getListLaporanNonpegawai';?>',
...
<script>
	...
	function cetakLaporan(){
        ...
        PopupCenter("http://localhost/poliklinik/index.php/laporan_nonpegawai/cetakLaporan/"+tgl_awal+"/"+tgl_akhir,"LAPORAN PEMERIKSAAN NON PEGAWAI","800","400");
    }
